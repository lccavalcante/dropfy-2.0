/*
	<div<class="box-drop">
		<a href="" class="open-drop">Selecione ...</a>
		<div class="box-drop-extended aberto" style="display: block;">
			<div class="drop-bg-topo"></div>
			<ul rel="cidade-extended" class="drop-extended">
				<li class="odd"><a rel="SÃƒÂ£o Paulo" href="#">SÃƒÂ£o Paulo</a></li>
				<li class="even"><a rel="Rio de Janeiro" href="#">Rio de Janeiro</a></li>
			</ul>
		...
		this.each(function(i, element){
			...
			*/
			_combobox.find('option').each(function(indice, value){
				...
				// console.log(  $(value).attr('selected' )
